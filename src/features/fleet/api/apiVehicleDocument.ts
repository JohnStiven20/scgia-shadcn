...
export const vehicleDocumentApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    findAllVehicleDocumentsByVehicle: builder.query<
      PageResponse<VehicleDocumentResponse>,
      SearchVehicleDocumentsParams
    >({
      query: ({ vehicleId }) => ({
